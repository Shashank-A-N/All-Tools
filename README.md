<p align="center">
  <img src="logo-final.png" alt="PDF AI Toolkit Logo" width="180"/>
</p>
...
<p align="center">
  <a href="#"><img src="https://img.shields.io/badge/Tools-150+-blueviolet?style=for-the-badge&logo=toolbox&logoColor=white" alt="150+ Tools"/></a>
  <a href="#"><img src="https://img.shields.io/badge/AI-Gemini%20Pro-4285F4?style=for-the-badge&logo=google&logoColor=white" alt="Gemini Pro"/></a>
  <a href="#"><img src="https://img.shields.io/badge/PWA-Installable-6d28d9?style=for-the-badge&logo=pwa&logoColor=white" alt="PWA"/></a>
  <a href="#"><img src="https://img.shields.io/badge/License-MIT-green?style=for-the-badge" alt="License"/></a>
  <a href="#"><img src="https://img.shields.io/badge/Privacy-100%25%20Client--Side-success?style=for-the-badge&logo=shield&logoColor=white" alt="Privacy"/></a>
</p>
...
```mermaid
graph LR
    A[Frontend] --> B[HTML5 / CSS3 / JavaScript ES6+]
    A --> C[TailwindCSS]
    A --> D[Three.js - 3D Backgrounds]
    A --> E[Lucide Icons + Font Awesome]
    A --> F[Google Fonts - Inter, Orbitron, Montserrat]
    
    G[AI Engine] --> H[Google Gemini Pro API]
    G --> I[Gemini Vision API]
    
    J[PDF Processing] --> K[pdf-lib]
    J --> L[pdf.js - Mozilla]
    J --> M[jsPDF]
    
    N[Media Processing] --> O[Web Audio API]
    N --> P[Canvas API]
    N --> Q[MediaRecorder API]
    N --> R[FFmpeg.wasm]
    
    S[Backend Services] --> T[Render.com - OCR/Repair/Protect]
    S --> U[Flask - Invoice Generator]
    
    V[PWA] --> W[Service Worker]
    V --> X[Web App Manifest]
```
...
<p align="center">
  ...
  <a href="https://github.com/Shashank-A-N">
    <img src="https://img.shields.io/badge/GitHub-Shashank--A--N-181717?style=for-the-badge&logo=github&logoColor=white" alt="GitHub Profile"/>
  </a>
</p>
